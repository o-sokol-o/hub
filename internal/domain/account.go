...
type AccountResponse struct {
	ID            int               `json:"id" example:"c4653bf9-5978-48b7-89c5-95704aebb7e2"`
	...
	SignupUserID  *int64            `json:"signup_user_id,omitempty" swaggertype:"int" example:"d69bdef7-173f-4d29-b52c-3edc60baf6a2"`
	BillingUserID *int64            `json:"billing_user_id,omitempty" swaggertype:"int" example:"d69bdef7-173f-4d29-b52c-3edc60baf6a2"`
...
func (m *Account) Response(ctx *gin.Context) *AccountResponse {
	if m == nil {
		return nil
	}
	...
	if m.SignupUserID != nil {
		r.SignupUserID = &m.SignupUserID.Int64
	}
	if m.BillingUserID != nil {
		r.BillingUserID = &m.BillingUserID.Int64
	}
...
func (m *Accounts) Response(ctx *gin.Context) []*AccountResponse {
...
type AccountCreateRequest struct {
	...
	SignupUserID  *int           `json:"signup_user_id,omitempty" validate:"omitempty" swaggertype:"string" example:"d69bdef7-173f-4d29-b52c-3edc60baf6a2"`
	BillingUserID *int           `json:"billing_user_id,omitempty" validate:"omitempty" swaggertype:"string" example:"d69bdef7-173f-4d29-b52c-3edc60baf6a2"`
}
...
type AccountDeleteRequest struct {
	ID int `json:"id" validate:"required" example:"d69bdef7-173f-4d29-b52c-3edc60baf6a2"`
}
